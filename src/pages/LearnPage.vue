    ...
    <div v-if="!noFlashcards">
      ...
      <div v-else class="flex flex-col items-center justify-center h-[60vh]">
        ...
        <button
          @click="refreshPage"
          type="button"
          class="animate-zoom text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 focus:outline-none"
        >
          Continue learning ?
        </button>
      </div>
